  ...
  obx_int.ModelEntity(
    ...
    properties: <obx_int.ModelProperty>[
      ...
      obx_int.ModelProperty(
        ...
        relationField: 'agenteInseritore',
    ...
    backlinks: <obx_int.ModelBacklink>[
      obx_int.ModelBacklink(
        name: 'proprieta',
        srcEntity: 'Immobile',
        srcField: 'proprietari',
      ),
      obx_int.ModelBacklink(
        name: 'colloqui',
        srcEntity: 'Colloquio',
        srcField: 'anagrafiche',
      ),
    ],
  ),
  obx_int.ModelEntity(
    ...
    properties: <obx_int.ModelProperty>[
      ...
      obx_int.ModelProperty(
        ...
        relationField: 'tipologiaAppuntamento',
  ...
  obx_int.ModelEntity(
    ...
    properties: <obx_int.ModelProperty>[
      ...
      obx_int.ModelProperty(
        ...
        relationField: 'immobileAbbinato',
      ...
      obx_int.ModelProperty(
        ...
        relationField: 'tipologiaColloquio',
  ...
  obx_int.ModelEntity(
    ...
    properties: <obx_int.ModelProperty>[
      ...
      obx_int.ModelProperty(
        ...
        relationField: 'tipologiaContatto',
  ...
  obx_int.ModelEntity(
    ...
    properties: <obx_int.ModelProperty>[
      ...
      obx_int.ModelProperty(
        ...
        relationField: 'statoConservativo',
      ...
      obx_int.ModelProperty(
        ...
        relationField: 'tipologiaImmobile',
      ...
      obx_int.ModelProperty(
        ...
        relationField: 'classeEnergetica',
  ...
  final bindings = <Type, obx_int.EntityDefinition>{
    Agente: obx_int.EntityDefinition<Agente>(
      ...
      toManyRelations: (Agente object) => {
        obx_int.RelInfo<Agente>.toMany(1, object.codAgente!): object.contatti,
      },
      ...
      objectToFB: (Agente object, fb.Builder fbb) {
        ...
        final cognomeOffset = object.cognome == null
            ? null
            : fbb.writeString(object.cognome!);
        ...
        final capOffset = object.cap == null
            ? null
            : fbb.writeString(object.cap!);
        final cittaOffset = object.citta == null
            ? null
            : fbb.writeString(object.citta!);
        fbb.startTable(8);
      ...
      objectFromFB: (obx.Store store, ByteData fbData) {
        ...
        final object = Agente()
          ..codAgente = const fb.Int64Reader().vTableGetNullable(
            buffer,
            rootOffset,
            4,
          )
        ...
        obx_int.InternalToManyAccess.setRelInfo<Agente>(
          object.contatti,
          store,
    ...
    Anagrafica: obx_int.EntityDefinition<Anagrafica>(
      ...
      toManyRelations: (Anagrafica object) => {
        ...
        obx_int.RelInfo<Anagrafica>.toMany(4, object.codAnagrafica!):
            object.appuntamenti,
        obx_int.RelInfo<Immobile>.toManyBacklink(12, object.codAnagrafica!):
            object.proprieta,
        obx_int.RelInfo<Colloquio>.toManyBacklink(13, object.codAnagrafica!):
            object.colloqui,
      },
      ...
      objectFromFB: (obx.Store store, ByteData fbData) {
        final buffer = fb.BufferContext(fbData);
        final rootOffset = buffer.derefObject(0);
        final dataInserimentoValue = const fb.Int64Reader().vTableGetNullable(
          buffer,
          rootOffset,
          20,
        );
        final object = Anagrafica()
          ..codAnagrafica = const fb.Int64Reader().vTableGetNullable(
            buffer,
            rootOffset,
            4,
          )
          ...
          ..ragioneSociale = const fb.StringReader(
            asciiOptimization: true,
          ).vTableGetNullable(buffer, rootOffset, 10)
          ..indirizzo = const fb.StringReader(
            asciiOptimization: true,
          ...
          ..commento = const fb.StringReader(
            asciiOptimization: true,
          ).vTableGetNullable(buffer, rootOffset, 22)
          ..storico = const fb.BoolReader().vTableGetNullable(
            buffer,
            rootOffset,
            24,
          )
        ...
        object.classeCliente.targetId = const fb.Int64Reader().vTableGet(
          buffer,
          rootOffset,
          26,
          0,
        ...
        object.agenteInseritore.targetId = const fb.Int64Reader().vTableGet(
          buffer,
          rootOffset,
          28,
          0,
    ...
    Appuntamento: obx_int.EntityDefinition<Appuntamento>(
      ...
      objectToFB: (Appuntamento object, fb.Builder fbb) {
        final iCalUIDOffset = object.iCalUID == null
            ? null
            : fbb.writeString(object.iCalUID!);
        final descrizioneOffset = object.descrizione == null
            ? null
            : fbb.writeString(object.descrizione!);
        final luogoOffset = object.luogo == null
            ? null
            : fbb.writeString(object.luogo!);
        fbb.startTable(9);
      ...
      objectFromFB: (obx.Store store, ByteData fbData) {
        ...
        final dataAppuntamentoValue = const fb.Int64Reader().vTableGetNullable(
          buffer,
          rootOffset,
          8,
        );
        final dataFineAppuntamentoValue = const fb.Int64Reader()
            .vTableGetNullable(buffer, rootOffset, 10);
        final object = Appuntamento()
          ..codAppuntamento = const fb.Int64Reader().vTableGetNullable(
            buffer,
            rootOffset,
            4,
          )
          ...
          ..iCalUID = const fb.StringReader(
            asciiOptimization: true,
          ).vTableGetNullable(buffer, rootOffset, 14)
          ..descrizione = const fb.StringReader(
            asciiOptimization: true,
          ).vTableGetNullable(buffer, rootOffset, 16)
          ..luogo = const fb.StringReader(
            asciiOptimization: true,
          ).vTableGetNullable(buffer, rootOffset, 18);
        object.tipologiaAppuntamento.targetId = const fb.Int64Reader()
    ...
    ClasseCliente: obx_int.EntityDefinition<ClasseCliente>(
      ...
      objectFromFB: (obx.Store store, ByteData fbData) {
        ...
        final object = ClasseCliente()
          ..codClasseCliente = const fb.Int64Reader().vTableGetNullable(
            buffer,
            rootOffset,
            4,
          )
          ...
          ..ordine = const fb.Int64Reader().vTableGetNullable(
            buffer,
            rootOffset,
            8,
          );
    ...
    ClasseEnergetica: obx_int.EntityDefinition<ClasseEnergetica>(
      ...
      objectFromFB: (obx.Store store, ByteData fbData) {
        ...
        final object = ClasseEnergetica()
          ..codClasseEnergetica = const fb.Int64Reader().vTableGetNullable(
            buffer,
            rootOffset,
            4,
          )
    ...
    Colloquio: obx_int.EntityDefinition<Colloquio>(
      ...
      objectFromFB: (obx.Store store, ByteData fbData) {
        ...
        final dataColloquioValue = const fb.Int64Reader().vTableGetNullable(
          buffer,
          rootOffset,
          16,
        );
        final object = Colloquio()
          ..codColloquio = const fb.Int64Reader().vTableGetNullable(
            buffer,
            rootOffset,
            4,
          )
          ...
          ..luogoIncontro = const fb.StringReader(
            asciiOptimization: true,
          ).vTableGetNullable(buffer, rootOffset, 18)
          ..scadenziere = const fb.BoolReader().vTableGetNullable(
            buffer,
            rootOffset,
            20,
          )
          ..commentoAgenzia = const fb.StringReader(
            asciiOptimization: true,
          ).vTableGetNullable(buffer, rootOffset, 22)
          ..commentoCliente = const fb.StringReader(
            asciiOptimization: true,
          ).vTableGetNullable(buffer, rootOffset, 24)
          ..codParent = const fb.Int64Reader().vTableGetNullable(
            buffer,
            rootOffset,
            26,
          )
        ...
        object.agenteInseritore.attach(store);
        object.immobileAbbinato.targetId = const fb.Int64Reader().vTableGet(
          buffer,
          rootOffset,
          10,
          0,
        ...
        object.tipologiaColloquio.targetId = const fb.Int64Reader().vTableGet(
          buffer,
          rootOffset,
          12,
          0,
    ...
    Contatto: obx_int.EntityDefinition<Contatto>(
      ...
      objectFromFB: (obx.Store store, ByteData fbData) {
        ...
        final object = Contatto()
          ..codContatto = const fb.Int64Reader().vTableGetNullable(
            buffer,
            rootOffset,
            4,
          )
          ..contatto = const fb.StringReader(
            asciiOptimization: true,
          ).vTableGetNullable(buffer, rootOffset, 6)
          ..descrizione = const fb.StringReader(
            asciiOptimization: true,
          ).vTableGetNullable(buffer, rootOffset, 8)
          ..codTipologiaContatto = const fb.Int64Reader().vTableGetNullable(
            buffer,
            rootOffset,
            10,
          )
        ...
        object.tipologiaContatto.targetId = const fb.Int64Reader().vTableGet(
          buffer,
          rootOffset,
          16,
          0,
    ...
    DatiCatastali: obx_int.EntityDefinition<DatiCatastali>(
      ...
      objectToFB: (DatiCatastali object, fb.Builder fbb) {
        final foglioOffset = object.foglio == null
            ? null
            : fbb.writeString(object.foglio!);
      ...
      objectFromFB: (obx.Store store, ByteData fbData) {
        ...
        final object = DatiCatastali()
          ..codDatiCatastali = const fb.Int64Reader().vTableGetNullable(
            buffer,
            rootOffset,
            4,
          )
          ..foglio = const fb.StringReader(
            asciiOptimization: true,
          ).vTableGetNullable(buffer, rootOffset, 6)
          ..particella = const fb.StringReader(
            asciiOptimization: true,
          ).vTableGetNullable(buffer, rootOffset, 8)
          ..subalterno = const fb.StringReader(
            asciiOptimization: true,
          ).vTableGetNullable(buffer, rootOffset, 10)
          ..categoria = const fb.StringReader(
            asciiOptimization: true,
          ).vTableGetNullable(buffer, rootOffset, 12)
          ..rendita = const fb.Float64Reader().vTableGetNullable(
            buffer,
            rootOffset,
            14,
          )
          ..redditoDomenicale = const fb.Float64Reader().vTableGetNullable(
            buffer,
            rootOffset,
            16,
          )
          ..redditoAgricolo = const fb.Float64Reader().vTableGetNullable(
            buffer,
            rootOffset,
            18,
          )
          ..dimensione = const fb.Float64Reader().vTableGetNullable(
            buffer,
            rootOffset,
            20,
          )
          ..codImmobile = const fb.Int64Reader().vTableGetNullable(
            buffer,
            rootOffset,
            22,
          );
    ...
    Immagine: obx_int.EntityDefinition<Immagine>(
      ...
      objectFromFB: (obx.Store store, ByteData fbData) {
        ...
        final object = Immagine()
          ..codImmagine = const fb.Int64Reader().vTableGetNullable(
            buffer,
            rootOffset,
            4,
          )
          ...
          ..pathImmagine = const fb.StringReader(
            asciiOptimization: true,
          ).vTableGetNullable(buffer, rootOffset, 10)
          ..imgPropsStr = const fb.StringReader(
            asciiOptimization: true,
          ).vTableGetNullable(buffer, rootOffset, 12);
    ...
    Immobile: obx_int.EntityDefinition<Immobile>(
      ...
      objectToFB: (Immobile object, fb.Builder fbb) {
        final rifOffset = object.rif == null
            ? null
            : fbb.writeString(object.rif!);
        final indirizzoOffset = object.indirizzo == null
            ? null
            : fbb.writeString(object.indirizzo!);
        final provinciaOffset = object.provincia == null
        ...
        final cittaOffset = object.citta == null
            ? null
            : fbb.writeString(object.citta!);
        final zonaOffset = object.zona == null
            ? null
            : fbb.writeString(object.zona!);
        final descrizioneOffset = object.descrizione == null
            ? null
            : fbb.writeString(object.descrizione!);
        ...
        final varieOffset = object.varie == null
            ? null
            : fbb.writeString(object.varie!);
        fbb.startTable(26);
      ...
      objectFromFB: (obx.Store store, ByteData fbData) {
        ...
        final dataLiberoValue = const fb.Int64Reader().vTableGetNullable(
          buffer,
          rootOffset,
          20,
        );
        final object = Immobile()
          ...
          ..mutuoDescrizione = const fb.StringReader(
            asciiOptimization: true,
          ).vTableGetNullable(buffer, rootOffset, 24)
          ..prezzo = const fb.Float64Reader().vTableGetNullable(
            buffer,
            rootOffset,
            26,
          )
          ..mutuo = const fb.Float64Reader().vTableGetNullable(
            buffer,
            rootOffset,
            28,
          )
          ..spese = const fb.Float64Reader().vTableGetNullable(
            buffer,
            rootOffset,
            30,
          )
          ..varie = const fb.StringReader(
            asciiOptimization: true,
          ).vTableGetNullable(buffer, rootOffset, 32)
          ..visione = const fb.BoolReader().vTableGetNullable(
            buffer,
            rootOffset,
            34,
          )
          ...
          ..affittabile = const fb.BoolReader().vTableGetNullable(
            buffer,
            rootOffset,
            38,
          )
          ..mq = const fb.Int64Reader().vTableGetNullable(
            buffer,
            rootOffset,
            40,
          )
          ..annoCostruzione = const fb.Int64Reader().vTableGetNullable(
            buffer,
            rootOffset,
            42,
          );
        ...
        object.agenteInseritore.attach(store);
        object.riscaldamento.targetId = const fb.Int64Reader().vTableGet(
          buffer,
          rootOffset,
          46,
          0,
        ...
        object.statoConservativo.targetId = const fb.Int64Reader().vTableGet(
          buffer,
          rootOffset,
          48,
          0,
        ...
        object.tipologiaImmobile.targetId = const fb.Int64Reader().vTableGet(
          buffer,
          rootOffset,
          50,
          0,
        ...
        object.classeEnergetica.targetId = const fb.Int64Reader().vTableGet(
          buffer,
          rootOffset,
          52,
          0,
    ...
    Riscaldamento: obx_int.EntityDefinition<Riscaldamento>(
      ...
      objectFromFB: (obx.Store store, ByteData fbData) {
        ...
        final object = Riscaldamento()
          ..codRiscaldamento = const fb.Int64Reader().vTableGetNullable(
            buffer,
            rootOffset,
            4,
          )
    ...
    StanzaImmobile: obx_int.EntityDefinition<StanzaImmobile>(
      ...
      objectFromFB: (obx.Store store, ByteData fbData) {
        ...
        final object = StanzaImmobile()
          ..codStanzaImmobile = const fb.Int64Reader().vTableGetNullable(
            buffer,
            rootOffset,
            4,
          )
        ...
        object.tipologiaStanza.targetId = const fb.Int64Reader().vTableGet(
          buffer,
          rootOffset,
          8,
          0,
    ...
    StatoConservativo: obx_int.EntityDefinition<StatoConservativo>(
      ...
      objectFromFB: (obx.Store store, ByteData fbData) {
        ...
        final object = StatoConservativo()
          ..codStatoConservativo = const fb.Int64Reader().vTableGetNullable(
            buffer,
            rootOffset,
            4,
          )
    ...
    TipologiaAppuntamento: obx_int.EntityDefinition<TipologiaAppuntamento>(
      ...
      getId: (TipologiaAppuntamento object) => object.codTipologiaAppuntamento,
      ...
      objectFromFB: (obx.Store store, ByteData fbData) {
        ...
        final object = TipologiaAppuntamento()
          ..codTipologiaAppuntamento = const fb.Int64Reader().vTableGetNullable(
            buffer,
            rootOffset,
            4,
          )
          ...
          ..gCalColor = const fb.StringReader(
            asciiOptimization: true,
          ).vTableGetNullable(buffer, rootOffset, 8)
          ..ordine = const fb.Int64Reader().vTableGetNullable(
            buffer,
    ...
    TipologiaColloquio: obx_int.EntityDefinition<TipologiaColloquio>(
      ...
      objectFromFB: (obx.Store store, ByteData fbData) {
        ...
        final object = TipologiaColloquio()
          ..codTipologiaColloquio = const fb.Int64Reader().vTableGetNullable(
            buffer,
            rootOffset,
            4,
          )
    ...
    TipologiaImmobile: obx_int.EntityDefinition<TipologiaImmobile>(
      ...
      objectFromFB: (obx.Store store, ByteData fbData) {
        ...
        final object = TipologiaImmobile()
          ..codTipologiaImmobile = const fb.Int64Reader().vTableGetNullable(
            buffer,
            rootOffset,
            4,
          )
    ...
    TipologiaStanza: obx_int.EntityDefinition<TipologiaStanza>(
      ...
      objectFromFB: (obx.Store store, ByteData fbData) {
        ...
        final object = TipologiaStanza()
          ..codTipologiaStanza = const fb.Int64Reader().vTableGetNullable(
            buffer,
            rootOffset,
            4,
          )
...
class Agente_ {
  ...
  static final codAgente = obx.QueryIntegerProperty<Agente>(
    _entities[0].properties[0],
  );

  /// See [Agente.nome].
  static final nome = obx.QueryStringProperty<Agente>(
    _entities[0].properties[1],
  );

  /// See [Agente.cognome].
  static final cognome = obx.QueryStringProperty<Agente>(
    _entities[0].properties[2],
  );

  /// See [Agente.indirizzo].
  static final indirizzo = obx.QueryStringProperty<Agente>(
    _entities[0].properties[3],
  );

  /// See [Agente.provincia].
  static final provincia = obx.QueryStringProperty<Agente>(
    _entities[0].properties[4],
  );

  /// See [Agente.cap].
  static final cap = obx.QueryStringProperty<Agente>(
    _entities[0].properties[5],
  );

  /// See [Agente.citta].
  static final citta = obx.QueryStringProperty<Agente>(
    _entities[0].properties[6],
  );

  /// see [Agente.contatti]
  static final contatti = obx.QueryRelationToMany<Agente, Contatto>(
...
class Anagrafica_ {
  ...
  static final codAnagrafica = obx.QueryIntegerProperty<Anagrafica>(
    _entities[1].properties[0],
  );

  /// See [Anagrafica.nome].
  static final nome = obx.QueryStringProperty<Anagrafica>(
    _entities[1].properties[1],
  );

  /// See [Anagrafica.cognome].
  static final cognome = obx.QueryStringProperty<Anagrafica>(
    _entities[1].properties[2],
  );

  /// See [Anagrafica.ragioneSociale].
  static final ragioneSociale = obx.QueryStringProperty<Anagrafica>(
    _entities[1].properties[3],
  );

  /// See [Anagrafica.indirizzo].
  static final indirizzo = obx.QueryStringProperty<Anagrafica>(
    _entities[1].properties[4],
  );

  /// See [Anagrafica.provincia].
  static final provincia = obx.QueryStringProperty<Anagrafica>(
    _entities[1].properties[5],
  );

  /// See [Anagrafica.cap].
  static final cap = obx.QueryStringProperty<Anagrafica>(
    _entities[1].properties[6],
  );

  /// See [Anagrafica.citta].
  static final citta = obx.QueryStringProperty<Anagrafica>(
    _entities[1].properties[7],
  );

  /// See [Anagrafica.dataInserimento].
  static final dataInserimento = obx.QueryDateProperty<Anagrafica>(
    _entities[1].properties[8],
  );

  /// See [Anagrafica.commento].
  static final commento = obx.QueryStringProperty<Anagrafica>(
    _entities[1].properties[9],
  );

  /// See [Anagrafica.storico].
  static final storico = obx.QueryBooleanProperty<Anagrafica>(
  ...
  static final agenteInseritore = obx.QueryRelationToOne<Anagrafica, Agente>(
    _entities[1].properties[12],
  );

  /// See [Anagrafica.codiceFiscale].
  static final codiceFiscale = obx.QueryStringProperty<Anagrafica>(
    _entities[1].properties[13],
  );

  /// See [Anagrafica.partitaIva].
  static final partitaIva = obx.QueryStringProperty<Anagrafica>(
    _entities[1].properties[14],
  );

  /// see [Anagrafica.contatti]
  static final contatti = obx.QueryRelationToMany<Anagrafica, Contatto>(
    _entities[1].relations[0],
  );

  /// see [Anagrafica.immobiliAbbinati]
  static final immobiliAbbinati = obx.QueryRelationToMany<Anagrafica, Immobile>(
...
class Appuntamento_ {
  ...
  static final codAppuntamento = obx.QueryIntegerProperty<Appuntamento>(
    _entities[2].properties[0],
  );

  /// See [Appuntamento.dataInserimento].
  static final dataInserimento = obx.QueryDateProperty<Appuntamento>(
    _entities[2].properties[1],
  );

  /// See [Appuntamento.dataAppuntamento].
  static final dataAppuntamento = obx.QueryDateProperty<Appuntamento>(
    _entities[2].properties[2],
  );

  /// See [Appuntamento.dataFineAppuntamento].
  static final dataFineAppuntamento = obx.QueryDateProperty<Appuntamento>(
  ...
  static final iCalUID = obx.QueryStringProperty<Appuntamento>(
    _entities[2].properties[5],
  );

  /// See [Appuntamento.descrizione].
  static final descrizione = obx.QueryStringProperty<Appuntamento>(
    _entities[2].properties[6],
  );

  /// See [Appuntamento.luogo].
  static final luogo = obx.QueryStringProperty<Appuntamento>(
...
class ClasseCliente_ {
  ...
  static final codClasseCliente = obx.QueryIntegerProperty<ClasseCliente>(
    _entities[3].properties[0],
  );

  /// See [ClasseCliente.descrizione].
  static final descrizione = obx.QueryStringProperty<ClasseCliente>(
    _entities[3].properties[1],
  );

  /// See [ClasseCliente.ordine].
  static final ordine = obx.QueryIntegerProperty<ClasseCliente>(
...
class ClasseEnergetica_ {
  ...
  static final codClasseEnergetica = obx.QueryIntegerProperty<ClasseEnergetica>(
    _entities[4].properties[0],
  );

  /// See [ClasseEnergetica.nome].
  static final nome = obx.QueryStringProperty<ClasseEnergetica>(
    _entities[4].properties[1],
  );

  /// See [ClasseEnergetica.descrizione].
  static final descrizione = obx.QueryStringProperty<ClasseEnergetica>(
    _entities[4].properties[2],
  );

  /// See [ClasseEnergetica.ordine].
  static final ordine = obx.QueryIntegerProperty<ClasseEnergetica>(
...
class Colloquio_ {
  ...
  static final codColloquio = obx.QueryIntegerProperty<Colloquio>(
    _entities[5].properties[0],
  );

  /// See [Colloquio.descrizione].
  static final descrizione = obx.QueryStringProperty<Colloquio>(
    _entities[5].properties[1],
  );

  /// See [Colloquio.agenteInseritore].
  static final agenteInseritore = obx.QueryRelationToOne<Colloquio, Agente>(
    _entities[5].properties[2],
  );

  /// See [Colloquio.immobileAbbinato].
  static final immobileAbbinato = obx.QueryRelationToOne<Colloquio, Immobile>(
  ...
  static final dataInserimento = obx.QueryDateProperty<Colloquio>(
    _entities[5].properties[5],
  );

  /// See [Colloquio.dataColloquio].
  static final dataColloquio = obx.QueryDateProperty<Colloquio>(
    _entities[5].properties[6],
  );

  /// See [Colloquio.luogoIncontro].
  static final luogoIncontro = obx.QueryStringProperty<Colloquio>(
    _entities[5].properties[7],
  );

  /// See [Colloquio.scadenziere].
  static final scadenziere = obx.QueryBooleanProperty<Colloquio>(
    _entities[5].properties[8],
  );

  /// See [Colloquio.commentoAgenzia].
  static final commentoAgenzia = obx.QueryStringProperty<Colloquio>(
    _entities[5].properties[9],
  );

  /// See [Colloquio.commentoCliente].
  static final commentoCliente = obx.QueryStringProperty<Colloquio>(
    _entities[5].properties[10],
  );

  /// See [Colloquio.codParent].
  static final codParent = obx.QueryIntegerProperty<Colloquio>(
    _entities[5].properties[11],
  );

  /// See [Colloquio.iCalUid].
  static final iCalUid = obx.QueryStringProperty<Colloquio>(
    _entities[5].properties[12],
  );

  /// see [Colloquio.anagrafiche]
  static final anagrafiche = obx.QueryRelationToMany<Colloquio, Anagrafica>(
...
class Contatto_ {
  ...
  static final codContatto = obx.QueryIntegerProperty<Contatto>(
    _entities[6].properties[0],
  );

  /// See [Contatto.contatto].
  static final contatto = obx.QueryStringProperty<Contatto>(
    _entities[6].properties[1],
  );

  /// See [Contatto.descrizione].
  static final descrizione = obx.QueryStringProperty<Contatto>(
    _entities[6].properties[2],
  );

  /// See [Contatto.codTipologiaContatto].
  static final codTipologiaContatto = obx.QueryIntegerProperty<Contatto>(
    _entities[6].properties[3],
  );

  /// See [Contatto.codAnagrafica].
  static final codAnagrafica = obx.QueryIntegerProperty<Contatto>(
    _entities[6].properties[4],
  );

  /// See [Contatto.codAgente].
  static final codAgente = obx.QueryIntegerProperty<Contatto>(
...
class DatiCatastali_ {
  ...
  static final codDatiCatastali = obx.QueryIntegerProperty<DatiCatastali>(
    _entities[7].properties[0],
  );

  /// See [DatiCatastali.foglio].
  static final foglio = obx.QueryStringProperty<DatiCatastali>(
    _entities[7].properties[1],
  );

  /// See [DatiCatastali.particella].
  static final particella = obx.QueryStringProperty<DatiCatastali>(
    _entities[7].properties[2],
  );

  /// See [DatiCatastali.subalterno].
  static final subalterno = obx.QueryStringProperty<DatiCatastali>(
    _entities[7].properties[3],
  );

  /// See [DatiCatastali.categoria].
  static final categoria = obx.QueryStringProperty<DatiCatastali>(
    _entities[7].properties[4],
  );

  /// See [DatiCatastali.rendita].
  static final rendita = obx.QueryDoubleProperty<DatiCatastali>(
    _entities[7].properties[5],
  );

  /// See [DatiCatastali.redditoDomenicale].
  static final redditoDomenicale = obx.QueryDoubleProperty<DatiCatastali>(
    _entities[7].properties[6],
  );

  /// See [DatiCatastali.redditoAgricolo].
  static final redditoAgricolo = obx.QueryDoubleProperty<DatiCatastali>(
    _entities[7].properties[7],
  );

  /// See [DatiCatastali.dimensione].
  static final dimensione = obx.QueryDoubleProperty<DatiCatastali>(
    _entities[7].properties[8],
  );

  /// See [DatiCatastali.codImmobile].
  static final codImmobile = obx.QueryIntegerProperty<DatiCatastali>(
...
class Immagine_ {
  ...
  static final codImmagine = obx.QueryIntegerProperty<Immagine>(
    _entities[8].properties[0],
  );

  /// See [Immagine.codImmobile].
  static final codImmobile = obx.QueryIntegerProperty<Immagine>(
    _entities[8].properties[1],
  );

  /// See [Immagine.ordine].
  static final ordine = obx.QueryIntegerProperty<Immagine>(
    _entities[8].properties[2],
  );

  /// See [Immagine.pathImmagine].
  static final pathImmagine = obx.QueryStringProperty<Immagine>(
    _entities[8].properties[3],
  );

  /// See [Immagine.imgPropsStr].
  static final imgPropsStr = obx.QueryStringProperty<Immagine>(
...
class Immobile_ {
  ...
  static final codImmobile = obx.QueryIntegerProperty<Immobile>(
    _entities[9].properties[0],
  );

  /// See [Immobile.rif].
  static final rif = obx.QueryStringProperty<Immobile>(
    _entities[9].properties[1],
  );

  /// See [Immobile.indirizzo].
  static final indirizzo = obx.QueryStringProperty<Immobile>(
    _entities[9].properties[2],
  );

  /// See [Immobile.provincia].
  static final provincia = obx.QueryStringProperty<Immobile>(
    _entities[9].properties[3],
  );

  /// See [Immobile.cap].
  static final cap = obx.QueryStringProperty<Immobile>(
    _entities[9].properties[4],
  );

  /// See [Immobile.citta].
  static final citta = obx.QueryStringProperty<Immobile>(
    _entities[9].properties[5],
  );

  /// See [Immobile.zona].
  static final zona = obx.QueryStringProperty<Immobile>(
    _entities[9].properties[6],
  );

  /// See [Immobile.dataInserimento].
  static final dataInserimento = obx.QueryDateProperty<Immobile>(
    _entities[9].properties[7],
  );

  /// See [Immobile.dataLibero].
  static final dataLibero = obx.QueryDateProperty<Immobile>(
    _entities[9].properties[8],
  );

  /// See [Immobile.descrizione].
  static final descrizione = obx.QueryStringProperty<Immobile>(
    _entities[9].properties[9],
  );

  /// See [Immobile.mutuoDescrizione].
  static final mutuoDescrizione = obx.QueryStringProperty<Immobile>(
    _entities[9].properties[10],
  );

  /// See [Immobile.prezzo].
  static final prezzo = obx.QueryDoubleProperty<Immobile>(
    _entities[9].properties[11],
  );

  /// See [Immobile.mutuo].
  static final mutuo = obx.QueryDoubleProperty<Immobile>(
    _entities[9].properties[12],
  );

  /// See [Immobile.spese].
  static final spese = obx.QueryDoubleProperty<Immobile>(
    _entities[9].properties[13],
  );

  /// See [Immobile.varie].
  static final varie = obx.QueryStringProperty<Immobile>(
    _entities[9].properties[14],
  );

  /// See [Immobile.visione].
  static final visione = obx.QueryBooleanProperty<Immobile>(
    _entities[9].properties[15],
  );

  /// See [Immobile.storico].
  static final storico = obx.QueryBooleanProperty<Immobile>(
    _entities[9].properties[16],
  );

  /// See [Immobile.affittabile].
  static final affittabile = obx.QueryBooleanProperty<Immobile>(
    _entities[9].properties[17],
  );

  /// See [Immobile.mq].
  static final mq = obx.QueryIntegerProperty<Immobile>(
    _entities[9].properties[18],
  );

  /// See [Immobile.annoCostruzione].
  static final annoCostruzione = obx.QueryIntegerProperty<Immobile>(
    _entities[9].properties[19],
  );

  /// See [Immobile.agenteInseritore].
  static final agenteInseritore = obx.QueryRelationToOne<Immobile, Agente>(
  ...
  static final immagini = obx.QueryRelationToMany<Immobile, Immagine>(
    _entities[9].relations[1],
  );

  /// see [Immobile.proprietari]
  static final proprietari = obx.QueryRelationToMany<Immobile, Anagrafica>(
    _entities[9].relations[2],
  );

  /// see [Immobile.colloqui]
  static final colloqui = obx.QueryBacklinkToMany<Colloquio, Immobile>(
    Colloquio_.immobileAbbinato,
  );
}
...
class Riscaldamento_ {
  ...
  static final codRiscaldamento = obx.QueryIntegerProperty<Riscaldamento>(
    _entities[10].properties[0],
  );

  /// See [Riscaldamento.descrizione].
  static final descrizione = obx.QueryStringProperty<Riscaldamento>(
...
class StanzaImmobile_ {
  ...
  static final codStanzaImmobile = obx.QueryIntegerProperty<StanzaImmobile>(
    _entities[11].properties[0],
  );

  /// See [StanzaImmobile.codImmobile].
  static final codImmobile = obx.QueryIntegerProperty<StanzaImmobile>(
  ...
  static final mq = obx.QueryIntegerProperty<StanzaImmobile>(
...
class StatoConservativo_ {
  ...
  static final descrizione = obx.QueryStringProperty<StatoConservativo>(
...
class TipologiaColloquio_ {
  ...
  static final descrizione = obx.QueryStringProperty<TipologiaColloquio>(
...
class TipologiaContatto_ {
  ...
  static final descrizione = obx.QueryStringProperty<TipologiaContatto>(
...
class TipologiaImmobile_ {
  ...
  static final descrizione = obx.QueryStringProperty<TipologiaImmobile>(
...
class TipologiaStanza_ {
  ...
  static final codTipologiaStanza = obx.QueryIntegerProperty<TipologiaStanza>(
    _entities[17].properties[0],
  );

  /// See [TipologiaStanza.descrizione].
  static final descrizione = obx.QueryStringProperty<TipologiaStanza>(
